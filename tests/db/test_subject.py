...
class SubjectTestCase(TestCase):
    def test_create(self):
        ...
        self.assertEqual(sub.url, "wss://split-ticket-svc.stake.decredbrasil.com:8477/watchWaitingList")
    ...
    def test_unique_url(self):
        ...
        sub_2 = Subject(emoji="🇧🇷 A", name="ASDDecred Brasil",
                        url="wss://split-ticket-svc.stake.decredbrasil.com:8477/watchWaitingList")
